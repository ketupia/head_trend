defmodule HeadTrendWeb.Router do
  use HeadTrendWeb, :router

  import HeadTrendWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {HeadTrendWeb.Layouts, :root}
  ...
  # scope "/api", HeadTrendWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:head_trend, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: HeadTrendWeb.Telemetry
